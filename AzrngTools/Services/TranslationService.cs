...
/// </summary>
public class TranslationService : ITranslationService, ITransientDependency
{
    ...
    /// <returns></returns>
    public async Task<string> YandexChineseToEnglishAsync(string chineseText)
    {
    ...
    /// <returns></returns>
    public async Task<string> YandexEnglishToChineseAsync(string englishText)
    {
